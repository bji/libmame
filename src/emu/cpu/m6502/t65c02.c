...
OP(02) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
OP(22) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
OP(42) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
OP(62) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
OP(82) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
OP(a2) { int tmp; RD_IMM; LDX;                      } /* 2 LDX IMM */
OP(c2) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
OP(e2) { int tmp; (void) tmp; RD_IMM; NOP;          } /* 2 NOP not sure for rockwell */
...
OP(44) { int tmp; (void) tmp; RD_ZPG; NOP;          } /* 3 NOP not sure for rockwell */
...
OP(54) { int tmp; (void) tmp; RD_ZPX; NOP;          } /* 4 NOP not sure for rockwell */
OP(74) { int tmp; STZ; WR_ZPX;                      } /* 4 STZ ZPX */
OP(94) { int tmp; STY; WR_ZPX;                      } /* 4 STY ZPX */
OP(b4) { int tmp; RD_ZPX; LDY;                      } /* 4 LDY ZPX */
OP(d4) { int tmp; (void) tmp; RD_ZPX; NOP;          } /* 4 NOP not sure for rockwell */
OP(f4) { int tmp; (void) tmp; RD_ZPX; NOP;          } /* 4 NOP not sure for rockwell */
...
OP(5c) { int tmp; (void) tmp; RD_ABX_C02_NP; RD_DUM; RD_DUM; RD_DUM; RD_DUM; } /* 8 NOP ABX not sure for rockwell. Page penalty not sure */
...
OP(dc) { int tmp; (void) tmp; RD_ABX_C02_NP; NOP;   } /* 4 NOP ABX not sure for rockwell. Page penalty not sure  */
OP(fc) { int tmp; (void) tmp; RD_ABX_C02_NP; NOP;   } /* 4 NOP ABX not sure for rockwell. Page penalty not sure  */
