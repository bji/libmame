...
OP(40) {                  RTI;                 } /* 6 RTI */
OP(60) {                  RTS;                 } /* 6 RTS */
OP(80) { int tmp; (void) tmp; RD_IMM; NOP;     } /* 2 NOP IMM */
...
OP(42) {                  KIL;                 } /* 1 KIL */
OP(62) {                  KIL;                 } /* 1 KIL */
OP(82) { int tmp; (void) tmp; RD_IMM; NOP;     } /* 2 NOP IMM */
OP(a2) { int tmp; RD_IMM; LDX;                 } /* 2 LDX IMM */
OP(c2) { int tmp; (void) tmp; RD_IMM; NOP;     } /* 2 NOP IMM */
OP(e2) { int tmp; (void) tmp; RD_IMM; NOP;     } /* 2 NOP IMM */
...
OP(04) { int tmp; (void) tmp; RD_ZPG; NOP;      } /* 3 NOP ZPG */
OP(24) { int tmp; RD_ZPG; BIT;                  } /* 3 BIT ZPG */
OP(44) { int tmp; (void) tmp; RD_ZPG; NOP;      } /* 3 NOP ZPG */
OP(64) { int tmp; (void) tmp; RD_ZPG; NOP;      } /* 3 NOP ZPG */
...
OP(14) { int tmp; (void) tmp; RD_ZPX; NOP;      } /* 4 NOP ZPX */
OP(34) { int tmp; (void) tmp; RD_ZPX; NOP;      } /* 4 NOP ZPX */
OP(54) { int tmp; (void) tmp; RD_ZPX; NOP;      } /* 4 NOP ZPX */
OP(74) { int tmp; (void) tmp; RD_ZPX; NOP;      } /* 4 NOP ZPX */
OP(94) { int tmp; STY; WR_ZPX;                  } /* 4 STY ZPX */
OP(b4) { int tmp; RD_ZPX; LDY;                  } /* 4 LDY ZPX */
OP(d4) { int tmp; (void) tmp; RD_ZPX; NOP;      } /* 4 NOP ZPX */
OP(f4) { int tmp; (void) tmp; RD_ZPX; NOP;      } /* 4 NOP ZPX */
...
OP(89) { int tmp; (void) tmp; RD_IMM; NOP;      } /* 2 NOP IMM */
...
OP(0c) { int tmp; (void) tmp; RD_ABS; NOP;      } /* 4 NOP ABS */
...
OP(1c) { int tmp; (void) tmp; RD_ABX_P; NOP;    } /* 4 NOP ABX page penalty */
OP(3c) { int tmp; (void) tmp; RD_ABX_P; NOP;    } /* 4 NOP ABX page penalty */
OP(5c) { int tmp; (void) tmp; RD_ABX_P; NOP;    } /* 4 NOP ABX page penalty */
OP(7c) { int tmp; (void) tmp; RD_ABX_P; NOP;    } /* 4 NOP ABX page penalty */
OP(9c) { int tmp; EA_ABX_NP; SYH; WB_EA;        } /* 5 SYH ABX */
OP(bc) { int tmp; RD_ABX_P; LDY;                } /* 4 LDY ABX page penalty */
OP(dc) { int tmp; (void) tmp; RD_ABX_P; NOP;    } /* 4 NOP ABX page penalty */
OP(fc) { int tmp; (void) tmp; RD_ABX_P; NOP;    } /* 4 NOP ABX page penalty */
