...
// This file does not define these legacy devices, not sure why; but
// libmame has to export them even though they are not used
const device_type FLOPPY_APPLE = 0, FLOPPY_SONY = 0;
#endif
